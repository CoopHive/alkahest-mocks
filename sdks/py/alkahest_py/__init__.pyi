...
class OracleClient:
    ...
    def request_arbitration(self, obligation_uid: Uid, oracle: Address, decision_context: BytesLike) -> Awaitable[HexStr]: ...
    def commitment_request_arbitration(self, intent_hash: HexStr, oracle: Address, decision_context: BytesLike) -> Awaitable[HexStr]: ...
    def arbitrate_raw(self, obligation: Uid, decision_context: BytesLike, decision: bool) -> Awaitable[HexStr]: ...
    def arbitrate_for_demand(self, obligation: Uid, demand: BytesLike, decision: bool) -> Awaitable[HexStr]: ...
    def commitment_arbitrate_raw(self, intent_hash: HexStr, decision_context: BytesLike, decision: bool) -> Awaitable[HexStr]: ...
    def commitment_arbitrate_for_demand(self, intent_hash: HexStr, demand: BytesLike, decision: bool) -> Awaitable[HexStr]: ...
    ...
    def commitment_existing_arbitration(self, intent_hash: HexStr, oracle: Address, decision_context: BytesLike) -> Awaitable[Any]: ...
    def wait_for_arbitration(self, obligation: Uid, decision_context: BytesLike, oracle: Address, from_block: int | None = None) -> Awaitable[Any]: ...
    def commitment_wait_for_arbitration(self, intent_hash: HexStr, oracle: Address, decision_context: BytesLike, from_block: int | None = None) -> Awaitable[Any]: ...
...
class TrustedOracleClient:
    def address_for(self, target: str) -> Address: ...
    def arbitrate_for_demand(self, obligation: Uid, demand: BytesLike, decision: bool) -> Awaitable[HexStr]: ...
    def arbitrate_raw(self, obligation: Uid, decision_context: BytesLike, decision: bool) -> Awaitable[HexStr]: ...
    def commitment_request_arbitration(self, intent_hash: HexStr, oracle: Address, decision_context: BytesLike) -> Awaitable[HexStr]: ...
    def commitment_arbitrate_for_demand(self, intent_hash: HexStr, demand: BytesLike, decision: bool) -> Awaitable[HexStr]: ...
    ...
    def commitment_existing_arbitration(self, intent_hash: HexStr, oracle: Address, decision_context: BytesLike) -> Awaitable[Any]: ...
    def commitment_wait_for_arbitration(self, intent_hash: HexStr, oracle: Address, decision_context: BytesLike, from_block: int | None = None) -> Awaitable[Any]: ...
    def commitment_wait_for_arbitration_request(self, intent_hash: HexStr, oracle: Address, from_block: int | None = None) -> Awaitable[Any]: ...
    def commitment_arbitrate_many(self, decision_func: Callable[..., Any], callback_func: Callable[..., Any] | None = None, mode: ArbitrationMode | None = None, timeout_seconds: float | None = None) -> Awaitable[list[Decision]]: ...
    def wait_for_arbitration(self, oracle: Address, obligation: Uid, decision_context: BytesLike, from_block: int | None = None) -> Awaitable[Any]: ...
    def decode(self, demand_bytes: BytesLike) -> TrustedOracleArbiterDemandData: ...
    @staticmethod
    def encode(oracle: Address, data: BytesLike) -> bytes: ...

class ArbitersClient:
    trusted_oracle: TrustedOracleClient
    logical: _Logical
