...
HexStr = str
Uid = str
BytesLike = bytes | bytearray | Sequence[int]
JsonValue = None | bool | int | float | str | Sequence["JsonValue"] | Mapping[str, "JsonValue"]
ApprovalPurpose = Literal["escrow", "payment", "atomic_payment"]
...
class ERC721EscrowObligationData(_Encodable):
    ...
    arbiter: Address
    demand: bytes
    def __init__(self, token: Address, token_id: str, arbiter: Address, demand: BytesLike) -> None: ...
    @staticmethod
...
class ERC721PaymentObligationData(_Encodable):
    ...
    token_id: str
    payee: Address
    def __init__(self, token: Address, token_id: str, payee: Address) -> None: ...
    @staticmethod
...
class ERC1155EscrowObligationData(_Encodable):
    ...
    arbiter: Address
    demand: bytes
    def __init__(self, token: Address, token_id: str, amount: str, arbiter: Address, demand: BytesLike) -> None: ...
    @staticmethod
...
class ERC1155PaymentObligationData(_Encodable):
    ...
    amount: str
    payee: Address
    def __init__(self, token: Address, token_id: str, amount: str, payee: Address) -> None: ...
    @staticmethod
...
class CommitRevealDemandData(_Encodable):
    bond_amount: str
    commit_deadline: str
    def __init__(self, bond_amount: str, commit_deadline: str) -> None: ...
    @staticmethod
...
class MockERC20:
    ...
    def transfer(self, to: Address, value: int) -> None: ...

class MockERC721:
    address: Address
    def __init__(self, address: Address, provider: WalletProvider) -> None: ...
    def approve(self, approved: Address, token_id: int) -> None: ...
    def balance_of(self, owner: Address) -> int: ...
    def get_approved(self, token_id: int) -> Address: ...
    def is_approved_for_all(self, account: Address, operator: Address) -> bool: ...
    def mint(self, to: Address) -> int: ...
    def owner_of(self, token_id: int) -> Address: ...
    def transfer_from(self, from_: Address, to: Address, token_id: int) -> None: ...

class MockERC1155:
    address: Address
    def __init__(self, address: Address, provider: WalletProvider) -> None: ...
    def balance_of(self, account: Address, token_id: int) -> int: ...
    def balance_of_batch(self, accounts: Sequence[Address], token_ids: Sequence[int]) -> list[int]: ...
    def is_approved_for_all(self, account: Address, operator: Address) -> bool: ...
    def mint(self, to: Address, token_id: int, amount: int) -> None: ...
    def safe_batch_transfer_from(self, from_: Address, to: Address, token_ids: Sequence[int], amounts: Sequence[int], data: BytesLike) -> None: ...
    def safe_transfer_from(self, from_: Address, to: Address, token_id: int, amount: int, data: BytesLike) -> None: ...
    def set_approval_for_all(self, operator: Address, approved: bool) -> None: ...
