export const abi = {
  ...
  "metadata": {
    ...
    "settings": {
      ...
      "compilationTarget": {
        "src/utils/splitters/default/TokenBundleSplitterBase.sol": "TokenBundleSplitterBase"
      },
      "evmVersion": "prague",
      "libraries": {},
      "viaIR": true
