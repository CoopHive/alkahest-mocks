export const abi = {
  ...
  "metadata": {
    ...
    "settings": {
      ...
      "compilationTarget": {
        "src/BaseArbiter.sol": "BaseArbiter"
      },
      "evmVersion": "prague",
      "libraries": {},
      "viaIR": true
