...
#forge create src/Statements/ERC20EscrowObligation.sol:ERC20EscrowObligation --rpc-url $RPC_URL --private-key $DEPLOYMENT_KEY --constructor-args $EAS_ADDRESS $EAS_SR_ADDRESS
#
...
# forge create src/Statements/TokenBundlePaymentObligation.sol:TokenBundlePaymentObligation --broadcast --rpc-url $RPC_URL --private-key $DEPLOYMENT_KEY --constructor-args  0xA1207F3BBa224E2c9c3c6D5aF63D0eb1582Ce587 0xA7b39296258348C78294F95B872b282326A97BDF
#
