...
contract ExpirationTimeEqualArbiterTest is Test {
    ...
    function testCheckStatementWithExpirationTimeEqual() public view {
        ...
        ExpirationTimeEqualArbiter.DemandData memory demandData = ExpirationTimeEqualArbiter.DemandData({
    ...
    function testCheckStatementWithExpirationTimeEqualButBaseArbiterReturnsFalse()
        public
        view
    {
        // Create a test attestation with expiration time equal to the required time
    ...
    function testDecodeDemandData() public {
        ExpirationTimeEqualArbiter.DemandData memory expectedDemandData = ExpirationTimeEqualArbiter.DemandData({
            expirationTime: expirationTimeValue,
            baseArbiter: address(mockArbiterTrue),
