...
import {ExpirationTimeBeforeArbiter} from "@src/arbiters/attestation-properties/non-composing/ExpirationTimeBeforeArbiter.sol";
...
contract ExpirationTimeBeforeArbiterTest is Test {
    ...
    function testCheckStatementWithExpirationTimeBeforeThreshold() public view {
        ...
        assertTrue(
            result,
            "Should accept attestation with expiration time before threshold"
        );
    }

    function testCheckStatementWithExpirationTimeAfterThreshold() public {
        ...
        // Check statement should revert with ExpirationTimeNotBefore
        vm.expectRevert(
