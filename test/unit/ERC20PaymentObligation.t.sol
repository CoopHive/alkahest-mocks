...
contract ERC20PaymentObligationTest is Test {
    ...
    function testConstructor() public {
        ...
        ISchemaRegistry.SchemaRecord memory schema = paymentObligation.getSchema();
    ...
    function testMakeStatement() public {
        ...
        // Make payment
        ERC20PaymentObligation.StatementData memory data = ERC20PaymentObligation.StatementData({
            token: address(token),
            amount: amount,
            payee: payee
        });
    ...
    function testMakeStatementFor() public {
        ...
        bytes32 attestationId = paymentObligation.makeStatementFor(data, payer, recipient);
    ...
    function testCheckStatement() public {
        ...
        ERC20PaymentObligation.StatementData memory exactDemand = ERC20PaymentObligation.StatementData({
            token: address(token),
            amount: amount,
            payee: payee
        });
        ...
        ERC20PaymentObligation.StatementData memory lowerDemand = ERC20PaymentObligation.StatementData({
            token: address(token),
        ...
        ERC20PaymentObligation.StatementData memory higherDemand = ERC20PaymentObligation.StatementData({
            token: address(token),
            amount: amount + 50 * 10**18,
            payee: payee
        });
        ...
        ERC20PaymentObligation.StatementData memory differentTokenDemand = ERC20PaymentObligation.StatementData({
        ...
        ERC20PaymentObligation.StatementData memory differentPayeeDemand = ERC20PaymentObligation.StatementData({
            token: address(token),
            amount: amount,
